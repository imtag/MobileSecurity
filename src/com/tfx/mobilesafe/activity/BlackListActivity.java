 ...
 * @id        $Id: BlackListActivity.java 34 2016-09-01 14:21:45Z tfx $
 */
...
public class BlackListActivity extends Activity {
	...
	private void showAddBlacklistDialog() {
		AlertDialog.Builder ab = new AlertDialog.Builder(BlackListActivity.this);
		//自定义view
...
//		pw = new PopupWindow(contentView, LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
	...
	private void initDate() {
		...
		new Thread() {
			public void run() {
				...
				// 2.加载数据
				mBlackBeans = mBlackListDao.findAll();
				//模拟耗时
	...
	private void initView() {
		...
		iv_blacklist_nodata = (TextView) findViewById(R.id.tv_blacklist_nodata);
